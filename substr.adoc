...
_Recommended practice_: Recommended practice: In the third and fourth forms, implementations should avoid allocation if `s.get_allocator() == a` is true.#
...
[underline]#*Rationale*: Improve efficiency of operations on xvalues.# +
